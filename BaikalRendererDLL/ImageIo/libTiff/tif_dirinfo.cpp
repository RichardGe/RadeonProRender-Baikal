...
_TIFFGetFields(void)
{
	tiffFieldArray = TIFFFieldArray( tfiatImage, 0, TIFFArrayCount(tiffFields), (TIFFField*) tiffFields );
...
{
	exifFieldArray = TIFFFieldArray( tfiatExif, 0, TIFFArrayCount(exifFields), (TIFFField*) exifFields );
